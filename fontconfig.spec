...
Source0  : https://www.freedesktop.org/software/fontconfig/release/fontconfig-2.15.0.tar.gz
...
%prep
%setup -q -n fontconfig-2.15.0
cd %{_builddir}/fontconfig-2.15.0
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a fontconfig-2.15.0 build32
popd
pushd ..
cp -a fontconfig-2.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703270668
...
/V3/usr/bin/fc-cache
/V3/usr/bin/fc-cat
/V3/usr/bin/fc-conflist
/V3/usr/bin/fc-list
/V3/usr/bin/fc-match
/V3/usr/bin/fc-pattern
/V3/usr/bin/fc-query
/V3/usr/bin/fc-scan
/V3/usr/bin/fc-validate
/usr/bin/fc-cache
/usr/bin/fc-cat
/usr/bin/fc-conflist
/usr/bin/fc-list
...
/usr/share/defaults/fonts/conf.d/10-sub-pixel-none.conf
/usr/share/defaults/fonts/conf.d/10-yes-antialias.conf
...
/usr/share/defaults/fonts/conf.d/48-spacing.conf
...
/usr/share/man/man3/FcConfigGetFilename.3
...
/usr/share/man/man3/FcNameGetConstantFor.3
...
/usr/share/man/man3/FcStrBuildFilename.3
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libfontconfig.so.1.12.1
/usr/lib64/libfontconfig.so.1
/usr/lib64/libfontconfig.so.1.12.1
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/fontconfig/6b63cb28fcb69a3ec7b61fa7827228803a659bc0
